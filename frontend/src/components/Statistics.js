...
const Statistics = ({ onClose }) => {
  ...
  const options = {
    ...
    plugins: {
      legend: { position: "top" },
      title: { display: true, text: "Event Statistics Overview" },
    },
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {[
            { label: "Total Events", value: totalEvents, bgColor: "#1e40af" },
            { label: "Registered for Events",value: registrations.length , bgColor: "#22c55e" },
            { label: "Pending Approvals for Events", value: pending.length, bgColor: "#facc15" },
            { label: "Approved Registrations for Events", value: accepted.length, bgColor: "#3b82f6" },
